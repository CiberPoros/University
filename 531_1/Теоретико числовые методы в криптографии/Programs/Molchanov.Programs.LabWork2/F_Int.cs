...
namespace Molchanov.Programs.LabWork2
{
    public class F_int
    {
        ...
        public static F_int Sqrt(F_int a)
        {
            ...
            if (a._val % 4 == 3)
            {
                x._val = BigInteger.ModPow(a._val, (a._mod + 1) / 4, a._mod);
                return x;
            }
            ...
            if (alpha == 1)
            {
                F_int answerr = new F_int(BigInteger.ModPow(a._val, (a._mod + 1) / 4, a._mod), a._mod);
            ...
            // step 4
            F_int b = new F_int(BigInteger.ModPow(n, s, a._mod), a._mod);

            // step 5
            F_int r = new F_int(BigInteger.ModPow(a._val, (s + 1) / 2, a._mod), a._mod);
            ...
            if (BigInteger.ModPow((r * r * a_obr)._val, buffer, a._mod) == 1)
            ...
            for (int k = 1; k < alpha - 1; k++)
            {
                ...
                F_int value = new F_int(BigInteger.ModPow(b._val, summ_j._val, a._mod), a._mod) * r;
                value = value * value * a_obr;
                value = new F_int(BigInteger.ModPow(value._val, buffer, a._mod), a._mod);
            ...
            F_int answer = new F_int(BigInteger.ModPow(b._val, summ_j._val, a._mod), a._mod) * r;
        ...
        {
            BigInteger val = BigInteger.ModPow(a._val, (a._mod - 1) / 2, a._mod);
            if (val == 1)
                return true;
            else
                return false;
